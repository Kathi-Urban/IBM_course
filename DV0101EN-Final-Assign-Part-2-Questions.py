...
app.layout = html.Div([
    ...
    style={'textAlign': 'center', 'color': '#503D36'}),#Include style for title
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        average_sales = recession_data.groupby('Vehicle-Type')['Automobile_Sales'].mean().reset_index()                 
        R_chart2  = dcc.Graph(
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
	...
	# Hint:Use Vehicle_Type and Advertising_Expenditure columns
        ...
        R_chart3 = dcc.Graph(
            ...
            title="Total Expenditure Shares By Vehicle Type During Recession"
        ))
